...
<script>
  ...
  export default {
    ...
    methods: {
        update(){
            this.$axios.put('/carreras/',this.nuevaCarrera).then((response) => {
        ...
        enviar(){
            this.$axios.post('/carreras',this.nuevaCarrera).then((response) => {
                console.log(response.data)
                this.get()
                this.nuevaCarrera.descripcion = ""
                this.modalVisible=false
        ...
        deleted(id){
            this.$axios.delete('/carreras/'+id).then((response) => {
                console.log(response.data)
                this.get()
            })
        },
