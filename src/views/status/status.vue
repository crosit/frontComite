            ...
            <b-container fluid class="mt--7">
                ...
                <b-card no-body class="bg-default shadow">
                    <b-card-header class="border-0">
                        <h3 class="mb-0">Estatus de Solicitudes</h3>
                    </b-card-header>
...
<script>
  ...
  export default {
    ...
    methods: {
        update(){
            this.$axios.put('/estatus/',this.nuevaCarrera).then((response) => {
        ...
        enviar(){
            this.$axios.post('/estatus',this.nuevaCarrera).then((response) => {
                console.log(response.data)
                this.get()
                this.nuevaCarrera.descripcion = ""
                this.modalVisible=false
        ...
        deleted(id){
            this.$axios.delete('/estatus/'+id).then((response) => {
                console.log(response.data)
                this.get()
            })
        },
