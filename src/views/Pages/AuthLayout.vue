       ...
       <div class="navbar-collapse-header">
         <b-row>
           <b-col cols="6" class="collapse-brand">
             <router-link to="/">
               <!-- <img src="img/brand/TSJZapopan_Logo.jpg"> -->
             </router-link>
           </b-col>
        ...
        <b-row align-v="center" class="justify-content-xl-between">
          <b-col xl="6">
            <div class="copyright text-center text-xl-left text-muted">
              © {{year}} <a href="https://github.com/crosit" class="font-weight-bold ml-1" target="_blank">chris Esparza</a>
            </div>
          </b-col>
          <b-col xl="6" class="col-xl-6">
            <b-nav  class="nav-footer justify-content-center justify-content-xl-end">
              <b-nav-item href="https://github.com/crosit" target="_blank" >
                chris Esparza
              </b-nav-item>
